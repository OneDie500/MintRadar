...
export default function BuyingAnalyzer() {
  const [open, setOpen] =
    useState(false);
            ...
            <div className="flex items-start justify-between gap-4 border-b border-zinc-900 p-5 sm:p-6">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-zinc-500">
                  Build a customer buy list from MintRadar&apos;s universal catalog, comp each item, and calculate your cash offer instantly.
                </p>
              </div>
              ...
              <button
                ...
                aria-label="Close Buying Analyzer"
              >
                ×
              </button>
            </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-600">
                      Apply one starting percentage to the whole buy list. You can still override any card individually.
                    </p>
                  </div>

                  <div className="flex w-full items-center rounded-xl border border-zinc-800 bg-black px-3 focus-within:border-emerald-400 sm:w-36">
                    <input
                      type="number"
                      min="0"
                      max="100"
                      ...
                      className="w-full bg-transparent py-3 text-center text-lg font-black text-white outline-none"
                    />
              ...
              <section>
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-600">
                      Search the universal catalog and add every raw card, slab, or sealed product you&apos;re considering buying.
                    </p>
                  </div>
